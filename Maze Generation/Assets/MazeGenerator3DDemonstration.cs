...
public class MazeGenerator3DDemonstration : MonoBehaviour
{
    ...
    public Material[] highlightColors = new Material[2];
    ...
    private void Update()
    {
        if (mazeParent != null)
        {
            mazeParent.transform.Rotate(Vector3.up, rotateSpeed * Time.deltaTime);
        }
    }

    public void CallGenerateMaze()
    {
    ...
    public IEnumerator RunAlgorithm()
    {
        ...
        currentCell.cScript.highlighter.GetComponent<MeshRenderer>().material = highlightColors[0];
        ...
        while (unvisited.Count > 0)
        {
            ...
            else if (stack.Count > 0)
            {
                ...
                currentCell.cScript.highlighter.GetComponent<MeshRenderer>().material = highlightColors[1];
            }
        }
    ...
    public void RemoveWall(CellScript3DDemonstration cScript, int wallID)
    {
    ...
    public void GenerateCell(Vector3 pos, Vector3 keyPos)
    {
        ...
        newCell.cScript = newCell.cellObject.GetComponent<CellScript3DDemonstration>();
    ...
    public class Cell
    {
        ...
        public CellScript3DDemonstration cScript;
    }
}
